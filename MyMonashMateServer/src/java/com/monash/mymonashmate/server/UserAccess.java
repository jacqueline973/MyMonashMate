...
@NamedQueries({
    ...
    @NamedQuery(name = "UserAccess.findByName", query = "SELECT u FROM UserAccess u WHERE u.name = :name"),
    @NamedQuery(name = "UserAccess.findByPassword", query = "SELECT u FROM UserAccess u WHERE u.password = :password"),
    @NamedQuery(name = "UserAccess.findByStudentId", query = "SELECT u FROM UserAccess u WHERE u.studentId = :studentId")})
public class UserAccess implements Serializable {
    ...
    public UserAccess(Integer id, String name, String password) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "com.monash.mymonashmate.server.UserAccess[ id=" + id + " ]";
    }
